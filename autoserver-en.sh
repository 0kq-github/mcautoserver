echo "###############################################################"
echo ""
echo "Minecraft Server Easy Build Tools for CentOS"
echo "eula https://www.minecraft.net/ja-jp/terms/r3/"
echo ""
echo "###############################################################"

read -p "eula (y/n): " eula
...
java -version &> /dev/null
 if [ $? -ne 0 ] ; then
  read -p "Would you like to install java? (y/n): " javainst
 else
  :
fi

read -p "Minecraft version(1.12-1.18.2): " mcver

read -p "Memory (must include \"G\" or \"M\"): " mem
...
chmod +x start.sh
echo "Build finished"
echo "you can run the server with commands below"
